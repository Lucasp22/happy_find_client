...
// // //   constructor() {
// // //     super();
// // //     //   this.state = {user_name: ''}, {user_email: ''}, {user_phone: ''}, {user_Address: ''}, {hours: ''}, {date: ''};
// // //     // }
...
// // //
// // //                     <label>Date</label>
// // //                     <input onChange={ this._handleChangeDate } value={this.state.date} name="date" type="text" placeholder="date" required  />
// // //
// // //                 <br/><br/>
